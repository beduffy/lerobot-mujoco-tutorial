...
try:
    ...
    print(f"Cannot import pandas: {e}")
...
# Reinstall numpy
print("\n=== Reinstalling numpy ===")
run_command([sys.executable, "-m", "pip", "install", "--upgrade", "--force-reinstall", "numpy"])

# Reinstall pandas
print("\n=== Reinstalling pandas ===")
run_command([sys.executable, "-m", "pip", "install", "--upgrade", "--force-reinstall", "pandas"])
